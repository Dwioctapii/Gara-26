...
`main.py` membuka empat proses terpisah: terminal debug, controls/PID, arena,
dan kamera. Setiap proses tersinkron ke backend melalui WebSocket. Pada Debian/Ubuntu, pasang Tkinter dengan
